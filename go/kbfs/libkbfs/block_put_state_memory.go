...
func (bps *blockPutStateMemory) oldPtr(
	...
	return data.BlockPointer{}, errors.WithStack(data.NoSuchBlockError{blockPtr.ID})
}
...
func (bps *blockPutStateMemory) getBlock(
	...
	return nil, errors.WithStack(data.NoSuchBlockError{blockPtr.ID})
}
...
func (bps *blockPutStateMemory) getReadyBlockData(
	...
	return data.ReadyBlockData{}, errors.WithStack(data.NoSuchBlockError{blockPtr.ID})
}
